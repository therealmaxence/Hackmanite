        ...
        <div>
          <div className="flex justify-between items-end mb-2">
            <span className="text-[10px] font-mono text-white/30 uppercase tracking-wider">
              {t('stats.linkage.cross_doc')}
            </span>
            <span className="font-mono text-xs text-white/70">
              {sharedPct.toFixed(1)}% {t('stats.linkage.shared_suffix')}
            </span>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 border-t border-white/[0.04] pt-6">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-[9px] text-white/30 italic">
              {t('stats.linkage.density_desc')}
            </span>
          </div>

          <div className="flex flex-col gap-1">
            <span className="text-[10px] font-mono text-white/30 uppercase tracking-wider">
              {t('stats.linkage.density_index')}
            </span>
            <span className="text-2xl font-bold font-mono text-white/95">
              {total > 0 ? (shared / total).toFixed(3) : '0.000'}
            </span>
            <span className="text-[9px] text-white/30 italic">
              {t('stats.linkage.density_index_desc')}
            </span>
          </div>
        </div>
      </div>

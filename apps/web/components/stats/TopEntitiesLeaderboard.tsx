...
export default function TopEntitiesLeaderboard({ topEntities, displayLimit, setDisplayLimit }: TopEntitiesLeaderboardProps) {
  const { t } = useTranslation();
  return (
    <div className="signature-card flex flex-col" style={{ padding: '2.5rem', gap: '2.5rem' }}>
      <div className="flex items-center justify-between shrink-0">
        <h3 className="text-sm font-semibold text-white/70">{t('stats.leaderboard.title')}</h3>

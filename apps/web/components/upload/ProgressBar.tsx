...
const statusProgress: Record<FileStatus, number> = { PENDING: 5, PROCESSING: 60, DONE: 100, FAILED: 100 };
const statusColor: Record<FileStatus, string> = { PENDING: 'var(--text-muted)', PROCESSING: 'var(--accent)', DONE: 'var(--success)', FAILED: 'var(--error)' };

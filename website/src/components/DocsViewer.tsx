  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 md:p-8 font-sans max-w-4xl mx-auto">
      <div className="flex items-center justify-between border-b border-[#18171c] pb-4 mb-6">
        ...
        <button
          onClick={handleCopy}
          className="btn-hackmanite flex items-center space-x-1.5 px-3 py-1.5 text-xs font-semibold bg-[#18171c] text-[#f0f0f4] border-none rounded"
        >
        ...
        <ReactMarkdown
          ...
          components={{
            ...
            code({ className, children, ...props }) {
              ...
              if (isBlock) {
                return (
                  <pre className="bg-[#18171c] border-none p-4 rounded-xl overflow-x-auto my-4 text-xs font-mono text-[#e0e7ff] leading-relaxed shadow-lg">
              ...
              return (
                <code className="bg-[#18171c] text-[#a78bfa] px-1.5 py-0.5 rounded border-none font-mono text-xs" {...props}>
                  {children}
                </code>
              );
            },
      ...
      <div className="grid grid-cols-2 gap-4 mt-12 pt-6 border-t border-[#18171c] text-xs">
        {prevDoc ? (
          <button
            ...
            className="btn-hackmanite p-4 rounded-xl bg-[#111014] border-none text-left transition-all group"
          >
        ...
        {nextDoc ? (
          <button
            ...
            className="btn-hackmanite p-4 rounded-xl bg-[#111014] border-none text-right transition-all group"
          >

...
9. **[Project Architecture](9_Project_Architecture.md)**
   * High-level system architecture, directory structure schema, dual SQLite/KuzuDB database schemas, and data flow.
